...
export function Hero() {
  return (
    ...
    >
      ...
      <div aria-hidden="true" className="hero-blob-delay-1 absolute w-12 h-12 bg-[#DC186D] rounded-full opacity-50 top-[20%] right-[12%] animate-float" />
      ...
      {/* Paint dots */}
      <div aria-hidden="true" className="absolute w-3 h-3 bg-[#DC186D] rounded-full opacity-40 top-[15%] left-[30%]" />
      <div aria-hidden="true" className="absolute w-2 h-2 bg-[#6EE7B7] rounded-full opacity-50 top-[70%] right-[25%]" />
      <div aria-hidden="true" className="absolute w-4 h-4 bg-[#8B51D6] rounded-full opacity-25 bottom-[20%] left-[45%]" />
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1280px] px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-[720px] mx-auto">
          {/* Eyebrow */}
          <div className="inline-flex items-center gap-2 bg-white border-2 border-[#C4B5FD] rounded-full px-[18px] py-[6px] text-[0.8125rem] font-nunito font-bold text-[#8B51D6] mb-5 shadow-sm">
            <span>🌟</span>
          ...
          <h1
            id="hero-headline"
            className="font-['Bubblegum_Sans'] text-[clamp(2.4rem,5vw,3.5rem)] text-[#8B51D6] leading-[1.1] mb-4"
          >
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link
              href="/coloring-pages"
              className="inline-flex items-center gap-2 px-7 py-[14px] bg-[#DC186D] hover:bg-[#EC4899] text-white font-nunito font-bold text-base rounded-full shadow-[0_4px_16px_rgba(155,111,212,0.12)] hover:shadow-[0_8px_32px_rgba(155,111,212,0.18)] hover:-translate-y-0.5 transition-all duration-200"
            >
              🖍 Browse Free Drawings
            </Link>
            <Link
              href="/shop"
              className="inline-flex items-center gap-2 px-7 py-[14px] bg-[#8B51D6] hover:bg-[#8B5CF6] text-white font-nunito font-bold text-base rounded-full shadow-[0_4px_16px_rgba(155,111,212,0.12)] hover:shadow-[0_8px_32px_rgba(155,111,212,0.18)] hover:-translate-y-0.5 transition-all duration-200"
            >
              ✨ See Premium Prints
            </Link>
          </div>
