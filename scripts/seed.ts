...
const ARTWORKS = [
  ...
  { slug: 'holiday-easter-card', title: 'Easter Card', description: 'A hand-made Easter card design with original colored artwork — cheerful and ready to print and give.', category: 'cards', age_group: '6-8', is_free: true, is_premium: false, artwork_type: 'finished_artwork', is_featured: false, is_new: true, watermark_enabled: false, sort_order: 18, seo_title: 'Easter Card — Original Artwork by Amalia', seo_description: 'Original Easter card artwork by child artist Amalia. Free to download or order as a printed postcard.' },
]
